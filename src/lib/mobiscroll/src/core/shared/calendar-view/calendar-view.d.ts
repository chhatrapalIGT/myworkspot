...
}, start: Date, end: Date, maxLabels: number, days: number, allDayOnly: boolean, firstWeekDay: number, isTimelineListing: boolean, eventOrder?: (a: MbscCalendarLabel, b: MbscCalendarLabel) => number, showLabelCount?: boolean, moreEventsText?: string, moreEventsPluralText?: string): {
