...
export const REQUEST_GET_USER_ROLE = 'requestgetUserRole';
export const SUCCESS_GET_USER_ROLE = 'getUserRoleSuccess';
export const FAILED_GET_USER_ROLE = 'getUserRoleFailed';
